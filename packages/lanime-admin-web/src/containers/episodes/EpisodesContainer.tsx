...
export default function EpisodesContainer() {
    ...
    const handleUpload = async (episodeId: string, file: File) => {
        ...
        try {
            ...
            queryClient.invalidateQueries({ queryKey: ['admin', 'encoding', episodeId] })
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (editing) {
            updateMutation.mutate(
                { id: editing.episodeId, data: form },
                {
                    onSuccess: () => {
                        setDialogOpen(false)
                        setEditing(null)
                ...
                <DialogContent className="max-w-sm">
                    ...
                    <DialogFooter>
                        ...
                        <Button
                            ...
                            onClick={() =>
                                deleteTarget &&
                                deleteMutation.mutate(deleteTarget.episodeId, {
